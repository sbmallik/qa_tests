...
# 51st
Given(/^this is the fifty-first test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text151, text152|
 visit url
 sleep 2
...
# 52nd
Given(/^this is the fifty-second test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the title "(.*?)" on the page$/) do |url, text161, text162|
 visit url
  sleep 2
...
# 53rd
Given(/^this is the fifty-third test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text171, text172|
 visit url
  sleep 2
...
# 54th
Given(/^this is the fifty-fourth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text181, text182|
 visit url
 sleep 2
...
# 55th
Given(/^this is the fifty-fifth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text191, text192|
 visit url
 sleep 2
...
# 56th
Given(/^this is the fifty-sixth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text201, text202|
 visit url
  sleep 2
...
# 57th
Given(/^this is the fifty-seventh test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the title "(.*?)" on the page$/) do |url, text211, text212|
 visit url
  sleep 2
...
# 58th
Given(/^this is the fifty-eighth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text221, text222|
 visit url
 sleep 2
...
# 59th
Given(/^this is the fifty-ninth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the title "(.*?)" on the page$/) do |url, text231, text232|
  visit url
  sleep 2
...
# 60th
Given(/^this is the sixtieth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text241, text242|
 visit url
 sleep 2
...
# 61st
Given(/^this is the sixty-first test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text251, text252|
 visit url
 sleep 2
...
# 62nd
Given(/^this is the sixty-second test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the title "(.*?)" on the page$/) do |url, text261, text262|
 visit url
  sleep 2
...
# 63rd
Given(/^this is the sixty-third test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the header "(.*?)" on the page$/) do |url, text271, text272|
 visit url
 sleep 2
...
# 66th
Given(/^this is the sixty-sixth test on the Comics homepage at "(.*?)" and I navigate to the "(.*?)" comics page, then I should see the title "(.*?)" on the page$/) do |url, text301, text302|
 visit url
  sleep 2
