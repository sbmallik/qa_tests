Feature: Check Design
	...
	Scenario: Check contest rules button
		Given that I am a visitor to the Rochester Choice Awards site
		When I visit http://democratandchronicle.secondstreetapp.com/l/Rochester-Democrat-and-Chronicles-Voters-Choice
		Then I should see a contest rules button
		And clicking it should go to http://democratandchronicle.secondstreetapp.com/l/Rochester-Democrat-and-Chronicles-Voters-Choice/Rules